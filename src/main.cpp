...
struct Scene {
	Vector3d background_color; // TODO: Figure out how to get a background color
	Vector3d ambient_light;  // I'm guessing this is the intensity of the brightness of the ambient light
...
bool Sphere::intersect(const Ray &ray, Intersection &hit) {
	// TODO (Assignment 2) calculate the intersection between ray and
	return false;
}
